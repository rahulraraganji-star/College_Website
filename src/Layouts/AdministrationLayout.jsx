...
const ADMIN_NAV = [
  { to: "/administration/organogram", label: "Organogram" },
  { to: "/administration/committees", label: "College Committees" },
  { to: "/administration/notices", label: "Notices & Announcements" },
];

function getActiveMeta(pathname) {
  const nav = ADMIN_NAV.find((x) => pathname.startsWith(x.to));
  return {
...
export default function AdministrationLayout() {
  ...
  return (
    <div className="relative min-h-screen bg-[#FBFBFD] text-neutral-900">
      ...
      {/* SAME PREMIUM BACKDROP AS ABOUT US */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-8 sm:py-10">
            ...
            <p className="mt-5 max-w-2xl text-sm sm:text-base leading-7 text-neutral-600">
              Centralized access to governance structures, committees, statutory
              bodies, and official institutional communications.
            </p>
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        {/* CONTEXT CARD — COPIED FROM ABOUT */}
 <div className="mb-8 rounded-[28px] p-[1px]
  bg-gradient-to-r from-amber-200/60 via-black/10 to-indigo-200/45
  ...
  <div className="relative overflow-hidden rounded-[27px] bg-white/75 backdrop-blur-xl">
    ...
    <div className="relative p-6 sm:p-8">
      ...
      <p className="mt-2 text-sm text-neutral-700 leading-6">
        ...
        {/* MAIN LAYOUT — SAME GRID AS ABOUT */}
        <div className="grid grid-cols-12 gap-8 lg:gap-10">

          {/* SIDEBAR — SAME CARD LANGUAGE */}
            ...
            <div className="rounded-[28px] border border-black/10 bg-white/75 backdrop-blur-xl shadow-[0_30px_120px_-70px_rgba(0,0,0,0.25)] overflow-hidden">
              <div className="border-b border-black/5 px-6 sm:px-10 py-6">
                <p className="text-sm text-neutral-600">
                  ...
                  <span className="text-neutral-500">Administrative content</span>
                </p>
              </div>
