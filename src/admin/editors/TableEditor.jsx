      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            type="button"
            onClick={addHeader}
            className="bg-gray-900 hover:bg-black text-white px-4 py-2 rounded-xl text-[13px] font-medium transition-colors"
          >
            + Add Column
          </button>
        </div>
          ...
          (header, index) => (
            ...
            >
              ...
              <button
                ...
                className="bg-red-500 hover:bg-red-600 text-white px-4 rounded-xl text-[13px] font-medium transition-colors"
              >
                Delete
              </button>
            </div>
                      ...
                      <tr key={rowIndex}>
                        ...
                        <td className="border p-2">
                          <button
                            ...
                            className="w-full bg-red-500 hover:bg-red-600 text-white rounded-lg py-2 text-[13px] font-medium transition-colors"
                          >
                            Delete
                          </button>
                        </td>
