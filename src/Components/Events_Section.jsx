...
const Events_Section = () => {
  ...
  // Back-side images (college/event poster vibe)
  const eventImages = [
    ,
  ...
  const dept = ["Cultural Committee", "Performing Arts Club", "Student Council"];
  const campusLine = ["Fr. Agnel Campus", "Fr. Agnel Auditorium", "Innovation Hub"];

  
  const updated = ["Updated this week", "Updated today", "Updated recently"];

  return (
    <section
      ref={sectionRef}
      className="relative h-screen bg-[#F1EEE8] flex items-center justify-center"
    >
      {/* HEADER */}
      <div className="absolute top-[18%] left-1/2 -translate-x-1/2 text-center z-20">
        <h1
          ref={headerRef}
          className="text-5xl mb-4  font-Playfair Display font-serif text-gray-900 "
        >
          What’s On Fr Agnel
        </h1>
            ...
            >
              ...
              <div className="absolute inset-0 rotate-y-180 backface-hidden bg-white border shadow-xl flex flex-col overflow-hidden rounded-2xl ring-1 ring-black/5">
                ...
                <div className="relative h-[58%] w-full">
                  ...
                  {/* Top row: dept badge + subtle mark */}
                ...
                <div className="flex-1 p-6 flex flex-col justify-between bg-white">
                  <div>
                    ...
                    {/* New “college style” detail row (no buttons) */}
